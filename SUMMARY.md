...
- [Commands](commands.md)
  ...
  - CATEGORY: [kamihime](commands/kamihime/README.md)
    - [glossary](commands/kamihime/glossary.md)
  ...
  - CATEGORY: [countdown](commands/countdown/README.md)
    ...
    - [countdown-current](commands/countdown/countdown-current.md)
    - [countdown-delete](commands/countdown/countdown-delete.md)
    - [countdown-help](commands/countdown/countdown-help.md)
  ...
  - CATEGORY: [fun](commands/fun/README.md)
    ...
    - [mock](commands/fun/mock.md)
    - [owo](commands/fun/owo.md)
